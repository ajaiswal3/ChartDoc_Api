...
namespace ChartDoc.Services.DataService
{
    ...
    public class FlowSheetService : IFlowSheetService
    {
        ...
        public FlowSheetService(IConfiguration configuration, ISharedService sharedService)
        {
                ...
                if (string.Compare(Convert.ToString(dtAppointment.Rows[index]["FlowArea"]), "Appointment") == 0 || String.IsNullOrWhiteSpace(Convert.ToString(dtAppointment.Rows[index]["FlowArea"])))
                {
                    flowSheetList.Add(new clsFlowSheet
                    {
                        schduleAppoinment = new clsScheduleAppointment
                        {
                            ...
                            patientName =_sharedService.Decrypt (Convert.ToString(dtAppointment.Rows[index]["PatientName"]))+ Convert.ToString(dtAppointment.Rows[index]["Acitivated"]),
                            colorCode = Convert.ToString(dtAppointment.Rows[index]["COLORCODE"]),
                            phoneNo = _sharedService.Decrypt( Convert.ToString(dtAppointment.Rows[index]["Phoneno"])),
                            email = _sharedService.Decrypt(Convert.ToString(dtAppointment.Rows[index]["Email"])),
                            dateOfBirth = Convert.ToString(dtAppointment.Rows[index]["DateofBirth"]),
                            gender = _sharedService.Decrypt(Convert.ToString(dtAppointment.Rows[index]["Gender"])),
                            address = _sharedService.Decrypt(Convert.ToString(dtAppointment.Rows[index]["Address"])),
                ...
                if (string.Compare(Convert.ToString(dtFlowsheet.Rows[index]["FlowArea"]).ToUpper(), "APPOINTMENT") == 0)
                {
                    lstFlowSheet.Add(new clsFlowSheet
                    {
                        schduleAppoinment = new clsScheduleAppointment
                        {
                            ...
                            patientName = _sharedService.Decrypt(Convert.ToString(dtFlowsheet.Rows[index]["PatientName"])) + Convert.ToString(dtFlowsheet.Rows[index]["Acitivated"]),
                            ...
                            gender = _sharedService.Decrypt( Convert.ToString(dtFlowsheet.Rows[index]["Gender"])),
                            phoneNo = _sharedService.Decrypt(Convert.ToString(dtFlowsheet.Rows[index]["Mob_No"])),
                            email = _sharedService.Decrypt(Convert.ToString(dtFlowsheet.Rows[index]["Email"])),
                            address = _sharedService.Decrypt(Convert.ToString(dtFlowsheet.Rows[index]["Add_Line"])),
                    ...
                    if (string.Compare(Convert.ToString(dtAppointment.Rows[index]["FlowArea"]).ToUpper(), "APPOINTMENT") == 0 || string.Compare(Convert.ToString(dtAppointment.Rows[index]["FlowArea"]), string.Empty) == 0)
                    {
                        lstFlowSheet.Add(new clsFlowSheet
                        {
                            schduleAppoinment = new clsScheduleAppointment
                            {
                                ...
                                toTime = Convert.ToString(dtAppointment.Rows[index]["ToTime"]),
                                patientId = Convert.ToString(dtAppointment.Rows[index]["PatientId"]),
                                patientName = _sharedService.Decrypt(Convert.ToString(dtAppointment.Rows[index]["PatientName"])),
                                colorCode = Convert.ToString(dtAppointment.Rows[index]["COLORCODE"]),
                                phoneNo = _sharedService.Decrypt(Convert.ToString(dtAppointment.Rows[index]["Phoneno"])),
                                email = _sharedService.Decrypt(Convert.ToString(dtAppointment.Rows[index]["Email"])),
                                dateOfBirth = Convert.ToString(dtAppointment.Rows[index]["DateofBirth"]),
                        ...
                        string.Compare(Convert.ToString(dtAppointmentWeekly.Rows[index]["FlowArea"]), string.Empty) == 0)
                    {
                        lstFlowSheet.Add(new clsFlowSheet
                        {
                            schduleAppoinment = new clsScheduleAppointment
                            {
                                ...
                                patientName = _sharedService.Decrypt(Convert.ToString(dtAppointmentWeekly.Rows[index]["PatientName"])) + Convert.ToString(dtAppointmentWeekly.Rows[index]["Acitivated"]),
                                colorCode = Convert.ToString(dtAppointmentWeekly.Rows[index]["COLORCODE"]),
                                phoneNo = _sharedService.Decrypt(Convert.ToString(dtAppointmentWeekly.Rows[index]["Phoneno"])),
                                email = _sharedService.Decrypt(Convert.ToString(dtAppointmentWeekly.Rows[index]["Email"])),
                                dateOfBirth = Convert.ToString(dtAppointmentWeekly.Rows[index]["DateofBirth"]),
                                gender = _sharedService.Decrypt(Convert.ToString(dtAppointmentWeekly.Rows[index]["Gender"])),
                                address = _sharedService.Decrypt(Convert.ToString(dtAppointmentWeekly.Rows[index]["Address"])),
                    ...
                    else if (string.Compare(Convert.ToString(dtAppointmentWeekly.Rows[index]["FlowArea"]).ToUpper(), "FINISH") == 0)
                    {
                        lstFlowSheet.Add(new clsFlowSheet
                        {
                            ...
                            checkingOut = new clsCheckingOut
                            {
                                ...
                                toTime = Convert.ToString(dtAppointmentWeekly.Rows[index]["ToTime"]),
                                patientID = Convert.ToString(dtAppointmentWeekly.Rows[index]["PatientId"]),
                                patientName = Convert.ToString(dtAppointmentWeekly.Rows[index]["PatientName"]) + Convert.ToString(dtAppointmentWeekly.Rows[index]["Acitivated"]),
